...
public class NOEsstianlEmergencylItem extends SugarRecord<NOEsstianlEmergencylItem> {
    String title;
    ...
    public NOEsstianlEmergencylItem(String title, String detial, String catSqure, String cat
    ...
    public NOEsstianlEmergencylItem() {
    }
