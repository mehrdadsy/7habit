...
public class EmergencyNOEssntialShowEditActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    EditText tilteEE;
    EditText detialEE;
    EditText calenderEE;
    TextView calenderText;
    NOEsstianlEmergencylItem EEItem;
    Spinner cat;
    String catToDB;
    int hours;
    int min;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_nessntial_show_edit);
        ...
        EEItem = NOEsstianlEmergencylItem.findById(NOEsstianlEmergencylItem.class,id);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(
                        EmergencyNOEssntialShowEditActivity.this,
        ...
        findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.matches("") && detial.matches("")) {
                    Toast.makeText(EmergencyNOEssntialShowEditActivity.this, "لطفا موارد خواسته شده و تاریخ را وارد کنید", Toast.LENGTH_SHORT).show();
                } else {
                    EEItem = NOEsstianlEmergencylItem.findById(NOEsstianlEmergencylItem.class, id);
                    ...
                    tilteEE.setText("");
                    detialEE.setText("");
                    Toast.makeText(EmergencyNOEssntialShowEditActivity.this, "کار ذخیره شد", Toast.LENGTH_SHORT).show();
                    finish();
        ...
        findViewById(R.id.cancel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EmergencyNOEssntialShowEditActivity.this, "ذخیره کار لغو شد", Toast.LENGTH_SHORT).show();
                finish();
