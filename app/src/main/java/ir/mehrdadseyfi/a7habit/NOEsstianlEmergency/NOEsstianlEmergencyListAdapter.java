...
public class NOEsstianlEmergencyListAdapter extends BaseAdapter {
    List<NOEsstianlEmergencylItem> models;
    Context mContext;

    public NOEsstianlEmergencyListAdapter(List<NOEsstianlEmergencylItem> models, Context mContext) {
        this.models = models;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View rowView = LayoutInflater.from(mContext).inflate(R.layout.emergency_nessntial_list_view, parent, false);
        ImageView img = (ImageView) rowView.findViewById(R.id.cat_img);
//        int src=Integer.parseInt(models.get(position).getCat());
        img.setImageResource(R.drawable.ene);
