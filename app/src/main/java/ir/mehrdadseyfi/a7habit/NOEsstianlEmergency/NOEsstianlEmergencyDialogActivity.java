...
public class NOEsstianlEmergencyDialogActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    EditText tilteEE;
    EditText detialEE;
    EditText calenderEE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_essntial_dialog_ene);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(
                        NOEsstianlEmergencyDialogActivity.this,
        ...
        findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.matches("") && detial.matches("")) {
                    ...
                    tilteEE.setText("");
                    detialEE.setText("");
                    Toast.makeText(NOEsstianlEmergencyDialogActivity.this, "کار ذخیره شد", Toast.LENGTH_SHORT).show();
//                    alarmManager();
                    finish();
        ...
        findViewById(R.id.cancel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NOEsstianlEmergencyDialogActivity.this, "ذخیره کار لغو شد", Toast.LENGTH_SHORT).show();
                finish();
