...
public class AlarmNotificationServiceENE extends IntentService {
    private NotificationManager alarmNotificationManager;

    //Notification ID for Alarm
    public static final int NOTIFICATION_ID = 1;

    public AlarmNotificationServiceENE() {
    ...
    private void sendNotification(String msg) {
        ...
        Intent intent = new Intent(this, NoEmergencyEssntialActivity.class);
        ...
        Notification notif = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("زمان انجام یه کار ضروری و غیراضطراری رسیده")
