...
import ir.mehrdadseyfi.a7habit.Esstinal.Noemergency.AlarmNotificationServiceENE;
...
public class NeeMyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context con, Intent arg1) {
        ...
        ComponentName comp = new ComponentName(con.getPackageName(),AlarmNotificationServiceENE.class.getName());
