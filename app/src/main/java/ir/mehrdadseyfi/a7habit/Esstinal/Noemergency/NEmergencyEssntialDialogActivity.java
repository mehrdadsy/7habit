...
public class NEmergencyEssntialDialogActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    EditText tilteEE;
    EditText detialEE;
    EditText calenderEE;
    TextView calenderText;
    NOEmergencyEssntialItem EEItem;
    Spinner cat;
    String catToDB;
    Date date2;
    int hours;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_essntial_dialog_nee);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(
                        NEmergencyEssntialDialogActivity.this,
        ...
        findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.matches("") && detial.matches("")) {
                    Toast.makeText(NEmergencyEssntialDialogActivity.this, "لطفا موارد خواسته شده و تاریخ را وارد کنید", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    EEItem = new NOEmergencyEssntialItem(title, detial, "ee", catToDB, String.valueOf(years), String.valueOf(mounth), String.valueOf(day), String.valueOf(hours), String.valueOf(minu));
                    EEItem.save();
                    tilteEE.setText("");
                    detialEE.setText("");
                    Toast.makeText(NEmergencyEssntialDialogActivity.this, "کار ذخیره شد", Toast.LENGTH_SHORT).show();
//                    alarmManager();
                    finish();
        ...
        findViewById(R.id.cancel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NEmergencyEssntialDialogActivity.this, "ذخیره کار لغو شد", Toast.LENGTH_SHORT).show();
                finish();
