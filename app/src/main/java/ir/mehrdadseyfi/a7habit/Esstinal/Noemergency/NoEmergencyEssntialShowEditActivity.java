...
public class NoEmergencyEssntialShowEditActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    EditText tilteEE;
    EditText detialEE;
    EditText calenderEE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nemergency_nessntial_show_edit);
        ...
        EEItem = NOEmergencyEssntialItem.findById(NOEmergencyEssntialItem.class,id);
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(
                        NoEmergencyEssntialShowEditActivity.this,
        ...
        findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.matches("") && detial.matches("")) {
                    Toast.makeText(NoEmergencyEssntialShowEditActivity.this, "لطفا موارد خواسته شده و تاریخ را وارد کنید", Toast.LENGTH_SHORT).show();
                } else {
                    EEItem = NOEmergencyEssntialItem.findById(NOEmergencyEssntialItem.class, id);
                   ...
                   if(years!=0&&day!=0&&hours!=0&&min!=0) {
                    ...
                    tilteEE.setText("");
                    detialEE.setText("");
                    Toast.makeText(NoEmergencyEssntialShowEditActivity.this, "کار ذخیره شد", Toast.LENGTH_SHORT).show();
                    finish();
        ...
        findViewById(R.id.cancel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NoEmergencyEssntialShowEditActivity.this, "ذخیره کار لغو شد", Toast.LENGTH_SHORT).show();
                finish();
