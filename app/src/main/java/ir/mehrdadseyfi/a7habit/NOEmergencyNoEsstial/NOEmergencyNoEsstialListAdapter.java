...
public class NOEmergencyNoEsstialListAdapter extends BaseAdapter {
    List<NOEmergencyNoEsstialItem> models;
    Context mContext;

    public NOEmergencyNoEsstialListAdapter(List<NOEmergencyNoEsstialItem> models, Context mContext) {
        this.models = models;
