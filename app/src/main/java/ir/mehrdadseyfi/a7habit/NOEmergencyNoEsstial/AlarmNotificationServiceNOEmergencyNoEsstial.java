...
public class AlarmNotificationServiceNOEmergencyNoEsstial extends IntentService {
    private NotificationManager alarmNotificationManager;

    //Notification ID for Alarm
    public static final int NOTIFICATION_ID = 1;

    public AlarmNotificationServiceNOEmergencyNoEsstial() {
    ...
    private void sendNotification(String msg) {
        ...
        Intent intent = new Intent(this, NOEmergencyNoEsstialActivity.class);
