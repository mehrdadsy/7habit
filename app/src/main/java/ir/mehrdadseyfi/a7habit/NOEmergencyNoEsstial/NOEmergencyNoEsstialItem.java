...
public class NOEmergencyNoEsstialItem extends SugarRecord<NOEmergencyNoEsstialItem> {
    String title;
    ...
    public NOEmergencyNoEsstialItem(String title, String detial, String catSqure, String cat
    ...
    public NOEmergencyNoEsstialItem() {
    }
